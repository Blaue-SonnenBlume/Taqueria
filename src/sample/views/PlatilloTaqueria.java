...
public class PlatilloTaqueria extends Stage {
    ...
    private void CrearTabla() {
        ...
        tbcIdPlatillos.setCellValueFactory(new PropertyValueFactory<>("idPlatillo"));
        ...
        tbcTamioPlatillo.setCellValueFactory(new PropertyValueFactory<>("tamanio"));
